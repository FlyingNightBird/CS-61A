...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    rightest=opponent_score%10;
    if player_score>=10:
        leftest=player_score//10;
    else:
        leftest=player_score;
    if leftest==rightest:
        return True;
    else:
        return False;
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # score0, score1 = score1, score0 is the same method for exchanging the value
